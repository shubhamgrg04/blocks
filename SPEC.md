> Current UI and retention: Tasks (⌘1) replaces Reports; Distractions (⌘2) is the only other tab. There is no Archive page or finished-session extension shortcut. Resolved distractions stay dimmed and crossed out until 24 hours after their persisted resolution timestamp; unresolved items stay until resolved. Start suggestions omit resolved items. Both timer popups show remaining and total planned session time, including extensions, with a progress ring. These rules supersede older archive and seven-day-expiry descriptions below.
